...
実機負荷試験（合成10,000ノート、Obsidian 1.13.4）を2026-09-19に実施しました。索引完了は52.1s→16.4s、UI停止なし、計測中に「Ready」の早期表示という不具合を1件発見して修正しました（ADR-015/ADR-016）。詳細は [result-load-10k.md](benchmark/result-load-10k.md)。
