...
実測で合格: **AT-01, AT-03, AT-04, AT-06, AT-08, AT-10, AT-12, AT-15, AT-16, AT-17, AT-18, AT-19, AT-20**（13件）
一部合格: AT-02, AT-05, AT-07, AT-09, AT-11, AT-13, AT-14（7件）
未実施: **なし**
実施不能: AT-07のDirect経路
...
- AT-02/05/09/11/13/14 の残作業（上表）

未実施はゼロになりましたが、**一部合格7件が残る版を安定版として公開しません**。
