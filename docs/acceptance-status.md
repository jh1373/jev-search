...
実測で合格: **AT-01, AT-02, AT-03, AT-04, AT-05, AT-06, AT-08, AT-09, AT-10, AT-11, AT-12, AT-15, AT-16, AT-17, AT-18, AT-19, AT-20**（17件）
一部合格: AT-07, AT-13, AT-14（3件）
未実施: **なし**
実施不能: AT-07のDirect経路
...
- AT-14 は実際のタグ付けと公開操作が未実施

未実施はゼロ、一部合格3件です。**残る3件が残る版を安定版として公開しません**。
