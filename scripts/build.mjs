...
await build({ entryPoints: ['src/main.ts'], bundle: true, external: ['obsidian','node:https'], platform: 'node', target: 'es2022', format: 'cjs', outfile: 'dist/main.js', logLevel: 'info' });
